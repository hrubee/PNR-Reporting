...
export const ORETA_EQUIPMENT_ITEMS = [
  ...
  { id: 14, name: "Iced tea machine", category: "Beverage & Refrigeration", defaultCleanedBy: "Rameshwar" },
  { id: 15, name: "Coffee machine 1", category: "Beverage & Refrigeration", defaultCleanedBy: "Rameshwar" },
  { id: 16, name: "Coffee machine 2", category: "Beverage & Refrigeration", defaultCleanedBy: "Rameshwar" },
  ...
  { id: 24, name: "Weighing Scale 1", category: "Containers & Prep", defaultCleanedBy: "Bharti" },
  { id: 25, name: "Weighing Scale 2", category: "Containers & Prep", defaultCleanedBy: "Bharti" },
  { id: 26, name: "Wet and Dry Dustbins", category: "Containers & Prep", defaultCleanedBy: "Mangla" },
  // Display & Retail
  { id: 27, name: "Cake counter 1", category: "Display & Retail", defaultCleanedBy: "Bharti" },
  { id: 28, name: "Cake counter 2", category: "Display & Retail", defaultCleanedBy: "Bharti" },
  { id: 29, name: "Ice cream counter", category: "Display & Retail", defaultCleanedBy: "Bharti" },
  { id: 30, name: "Food rack", category: "Display & Retail", defaultCleanedBy: "Bharti" },
  { id: 31, name: "Food Rack Top", category: "Display & Retail", defaultCleanedBy: "Bharti" },
  { id: 32, name: "Store rack", category: "Display & Retail", defaultCleanedBy: "Bharti" },
  { id: 33, name: "Store room", category: "Display & Retail", defaultCleanedBy: "Bharti" },
  { id: 34, name: "Cabinet cleaning", category: "Display & Retail", defaultCleanedBy: "Mangla" },
  { id: 35, name: "Cash Counter", category: "Display & Retail", defaultCleanedBy: "Bharti" },
...
export const RNS_EQUIPMENT_ITEMS = [
  ...
  // Display & Retail
  { id: 17, name: "Cake Counter 1", category: "Display & Retail", defaultCleanedBy: "Madhavi" },
  { id: 18, name: "Cake Counter 2", category: "Display & Retail", defaultCleanedBy: "Madhavi" },
  ...
  { id: 21, name: "Food Rack", category: "Display & Retail", defaultCleanedBy: "Sachin" },
  { id: 22, name: "Cabinet Cleaning", category: "Display & Retail", defaultCleanedBy: "Ashok" },
  { id: 23, name: "Cash Counter", category: "Display & Retail", defaultCleanedBy: "Madhavi" },
  { id: 24, name: "Gods Altar", category: "Display & Retail", defaultCleanedBy: "Madhavi" },
...
export const SYMPHONY_EQUIPMENT_ITEMS = [
  ...
  // Display & Retail
  { id: 16, name: "Cake Counter 1", category: "Display & Retail", defaultCleanedBy: "Rahul" },
  { id: 17, name: "Cake Counter 2", category: "Display & Retail", defaultCleanedBy: "Rahul" },
  { id: 18, name: "Cake Counter 3", category: "Display & Retail", defaultCleanedBy: "Rahul" },
  { id: 19, name: "IceCream Counter", category: "Display & Retail", defaultCleanedBy: "Kamran" },
  { id: 20, name: "Food Rack", category: "Display & Retail", defaultCleanedBy: "Someshwar" },
  { id: 21, name: "Food Rack Top Counter", category: "Display & Retail", defaultCleanedBy: "Someshwar" },
  ...
  { id: 25, name: "Cash Counter", category: "Display & Retail", defaultCleanedBy: "Rahul" },
